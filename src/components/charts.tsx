...
export function ProductEmissionChart() {
  ...
  const data = {
    labels: chartMonths,
    datasets: [
      { label: "EN8 Shafts", data: productEmissions.Shafts, backgroundColor: "#072115", borderRadius: 4 },
      { label: "Cast Gears", data: productEmissions.Gears, backgroundColor: "#10b981", borderRadius: 4 },
      { label: "Steel Plates", data: productEmissions.Casings, backgroundColor: "#48a65e", borderRadius: 4 },
      { label: "Flanges", data: productEmissions.Valves, backgroundColor: "#34d399", borderRadius: 4 },
    ]
  };
  return <Bar options={customOptions} data={data} />;
}
