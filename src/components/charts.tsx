...
const options = {
  ...
  plugins: { legend: { display: false }, tooltip: { backgroundColor: "#072115", padding: 12, cornerRadius: 8, titleColor: "#ffffff", bodyColor: "#e1e8e2" } },
  scales: { x: { grid: { display: false }, ticks: { color: "#637381", font: { weight: 500 } } }, y: { grid: { color: grid }, border: { display: false }, ticks: { color: "#637381" } } },
};
